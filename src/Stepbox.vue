<template>
  <nav>
    <div class="ui mini steps">
      <div v-for="item in iData" :key="item.title" :class="{'step':true,'active ':item.active}">
        <i v-if="item.icon" :class="[item.icon,{'icon':true}]"></i>
        <div class="content">
          <div class="title">{{item.title}}</div>
          <div v-if="item.des" class="description">{{item.des}}</div>
        </div>
      </div>
    </div>
  </nav>
...
/* Title */
.ui.steps .step .title {
  font-family: "Lato", "Helvetica Neue", Arial, Helvetica, sans-serif, Sukhumvit;
